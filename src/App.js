...
//     // fetch response to the chatLog array of messages and sending it as a message to localhost:3000 as a post
...
//     await setChatLog((prevChatLog) => [
//       ...prevChatLog,
//       { user: "gpt", message: data.message } // Corrected `message` property
//     ]);
//     // setChatLog([...chatLog, { user: "gpt", mesage: `${data.message}`}])
